...
if version >= 508 || !exists("did_sql_syn_inits")
    ...
    HiLink sqlClickhouseKeyword         Special
    HiLink sqlClickhouseStatement       String
    HiLink sqlClickhouseFunction        Function
    HiLink sqlClickhouseType            Type

    delcommand HiLink
endif

highlight sqlClickhouseTypeFunction cterm=italic gui=italic     guifg=#3FBB7D
highlight sqlClickhouseAggregateFunction                        guifg=#D0EE4A
